                ...
                <div class="sa-sidebar__header">
                    <a class="sa-sidebar__logo" href="index.html">
                        ...
                        <div class="sa-sidebar-logo">
                            <span class="h5 mb-0 text-uppercase text-primary bg-dark px-2">QUANG</span>
                            <span class="h5 mb-0 text-uppercase text-dark bg-white px-2 ml-n1">HAO</span>
                        </div>
                        <!-- logo / end -->
                    </a>
                </div>
                        ...
                        <li class="sa-nav__section">
                            <ul class="sa-nav__menu sa-nav__menu--root">
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                    <a href="admin.php?mod=page&act=dasdboard" class="sa-nav__link">
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                    <a href="admin.php?mod=product&act=admin&page=1" class="sa-nav__link">
                                        <span class="sa-nav__icon">
                    ...
                    <div class="dropdown sa-toolbar__item">
                        <button class="sa-toolbar-user" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown"
                            ...
                            <span class="sa-toolbar-user__avatar sa-symbol sa-symbol--shape--rounded">
                                <img src="assets_admin/images/customers/nguyen.jpg" width="64" height="64">
                            </span>
                        ...
                        <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuButton">
                            <li>
                                <a class="dropdown-item" href="?mod=user&act=logout">Sign Out</a>
                            </li>
                        </ul>
                    </div>
                </div>
