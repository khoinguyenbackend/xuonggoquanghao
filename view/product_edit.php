                    ...
                    <div class="sa-entity-layout__body">
                        <div class="sa-entity-layout__main">
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input
                                            ...
                                            name="tensp" value="<?=$data['sp']['tensp']?>"/>
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div>
                                        <label for="form-product/short-description" class="form-label">Short
                                            description</label>
                                        <textarea id="form-product/short-description" 
                                                class="form-control"
                                                rows="2" 
                                                name="motangan">
                                                <?=$data['sp']['motangan']?>
                            ...
                            <div class="card mt-5">
                                <div class="card-body p-5">
                                    <div class="mb-5">
                                        <h2 class="mb-0 fs-exact-18">sale price</h2>
                                    </div>
                                    <div class="row g-4">
                                        <div class="col">
                                            <label for="form-product/price"
                                                ...
                                                <input 
                                                    ...
                                                    name="giakhuyenmai" value="<?=$data['sp']['giakhuyenmai']?>" />
                                        </div>
                                        <div class="col">
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            name="soluong"value="<?=$data['sp']['soluong']?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="sa-entity-layout__sidebar">
                            <div class="card">
                                ...
                                <div class="mt-n5">
                                    <img src="upload/product/<?=$data['sp']['anhsp']?>" class="img-choose">
                                <input 
                                        type="file" 
