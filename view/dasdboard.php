                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><img src="assets_admin/vendor/flag-icons/24/IT.png"
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="assets_admin/vendor/flag-icons/24/DE.png"
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="assets_admin/vendor/flag-icons/24/US.png"
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="assets_admin/vendor/flag-icons/24/CO.png"
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="assets_admin/vendor/flag-icons/24/RS.png"
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="assets_admin/vendor/flag-icons/24/FR.png"
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="assets_admin/vendor/flag-icons/24/RU.png"
                                ...
                                <ul class="list-group list-group-flush">
                                        ...
                                        <div class="d-flex align-items-center py-3">
                                            <a href="app-product.html" class="me-4">
                                                <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                    <img src="assets_admin/images/products/product-1-40x40.jpg" width="40"
                                                        height="40" alt="" />
                                                </div>
                                            </a>
                                    ...
                                    <li class="list-group-item py-2">
                                        <div class="d-flex align-items-center py-3">
                                            <a href="app-product.html" class="me-4">
                                                <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                    <img src="assets_admin/images/products/product-7-40x40.jpg" width="40"
                                                        height="40" alt="" />
                                                </div>
                                            </a>
                                            <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                    ...
                                    <li class="list-group-item py-2">
                                        <div class="d-flex align-items-center py-3">
                                            <a href="app-product.html" class="me-4">
                                                <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                    <img src="assets_admin/images/products/product-10-40x40.jpg" width="40"
                                                        height="40" alt="" />
                                                </div>
                                            </a>
                                            <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                    ...
                                    <li class="list-group-item py-2">
                                        <div class="d-flex align-items-center py-3">
                                            <a href="app-product.html" class="me-4">
                                                <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                    <img src="assets_admin/images/products/product-5-40x40.jpg" width="40"
                                                        height="40" alt="" />
                                                </div>
                                            </a>
                                            <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                    ...
                                    <li class="list-group-item py-2">
                                        <div class="d-flex align-items-center py-3">
                                            <a href="app-product.html" class="me-4">
                                                <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                    <img src="assets_admin/images/products/product-2-40x40.jpg" width="40"
                                                        height="40" alt="" />
                                                </div>
                                            </a>
                                            <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                    ...
                                    <li class="list-group-item py-2">
                                        <div class="d-flex align-items-center py-3">
                                            <a href="app-product.html" class="me-4">
                                                <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                    <img src="assets_admin/images/products/product-16-40x40.jpg" width="40"
                                                        height="40" alt="" />
                                                </div>
                                            </a>
                                            <div class="d-flex align-items-center flex-grow-1 flex-wrap">
